        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center text_image_5050__image <?=$order_right?>" data-aos="<?=$fade_right?>">
                <div class="ratio ratio-16x9">
                    <iframe src="https://player.vimeo.com/video/<?=$vimeo_id?>?badge=0&amp;autopause=0&amp;quality_selector=1&amp;player_id=0&amp;app_id=58479" allow="autoplay; fullscreen; picture-in-picture" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="AOS - White Gold"></iframe>
                </div>
            </div>
        </div>
    </div>
